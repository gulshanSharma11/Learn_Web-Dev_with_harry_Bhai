            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5">
                <input
                  ...
                  name="email"
                  className="w-full pr-4 py-3 border-b border-solid px-4 border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor rounded-md cursor-pointer"
                  required
                />
              </div>
              <div className="mb-5">
              ...
              <div className="mb-5 flex items-center gap-3">
                { selectFile && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
